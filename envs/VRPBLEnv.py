...
class VRPBLEnv:
    ...
    def clone(self, deep_clone_history=False):
        ...
        # Bypass __init__
        cloned = VRPBLEnv.__new__(VRPBLEnv)
        ...
        cloned.pomo_size = self.pomo_size # pomo_size được tính lại trong load_problems
        ...
        # THUỘC TÍNH MỚI CỦA BINH ĐOÀN NÀY:
        ...
        cloned.length = self.length.clone() if self.length is not None else None # <-- Quan trọng
